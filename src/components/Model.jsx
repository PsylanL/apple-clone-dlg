...
const Model = () => {
    ...
    useEffect(() => {
        if(size === 'large'){
            animateWithGsapTimeline(tl, small,smallRotation,'#view1','#view2', //from view1 to view2
            {transform: 'translateX(-100%)', duration:2})
        }
        if(size === 'small'){
            animateWithGsapTimeline(tl, large, largeRotation,'#view2','#view1',//from view2 to view1
        ...
        <div className="screen-max-width">
            ...
            <div className="flex flex-col items-center mt-5">
                <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
                    ...
                    >
                        <View.Port />//A way to render multiple views of a model in the same canvas
                    </Canvas>
                </div>
